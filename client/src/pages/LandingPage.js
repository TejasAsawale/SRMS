...
const LandingPage = () => {
    ...
    return (
        <div className={`lp-container ${theme}-theme`}>
            ...
            <nav className={`lp-nav ${scrolled ? 'lp-nav-scrolled' : ''}`}>
                ...
                <div className="lp-nav-links">
                    ...
                    {/* --- Theme Portal Button (Matches Login Style) --- */}
                    <button
                        onClick={toggleTheme}
                        className="lp-theme-portal-btn"
                    >
            ...
            <section id="contact" className="lp-contact-section">
                <div className="lp-contact-container">
                    <div className="lp-section-header">
                        <p className="lp-sub-tag">Get In Touch</p>
                        {/* Remove the inline style color: #fff so CSS can handle it dynamically */}
                    ...
                    {contactSent ? (
                        ...
                        /* Added 'lp-contact-card' class here */
